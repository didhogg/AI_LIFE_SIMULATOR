...
describe('战术包库 · 剥离③', () => {
    ...
    it('④ resolve() 挂载 战术包成品', () => {
        ...
        const result = resolve({ packs: [] }, {}, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, lib);
    ...
    it('④ resolve() 挂载 manifest.战术包', () => {
        ...
        const result = resolve({ packs: [], 战术包: ['flanking'] }, {}, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, lib);
    ...
    it('④ 库中不存在的引用 → 跳过（不入墓碑）', () => {
        ...
        const result = resolve({ packs: [], 战术包: ['missing_id', 'flanking'] }, {}, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, lib);
        expect(Object.keys(result.战术包成品)).toEqual(['flanking']);
    });
