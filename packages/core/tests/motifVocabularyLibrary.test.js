...
describe('母题词汇库 · 剥离③', () => {
    ...
    it('④ resolve() 挂载 母题词汇成品', () => {
        ...
        const result = resolve({ packs: [], 母题词汇: ['romance'] }, {}, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, lib);
    ...
    // 断言⑦ 守恒门
    it('⑦ 守恒门：schemaKeys=54 / BUNDLE=21 / 命名空间枚举=32项（含母题词汇）', () => {
