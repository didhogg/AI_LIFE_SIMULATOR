...
import { 种族模板库Schema, 种族模板定义条目Schema, 种族模板ID正则, 投影种族模板库, } from '../schema/raceTemplateLibrary.js';
...
describe('种族模板库 · 剥离③', () => {
    ...
    it('⑥ resolve() 挂载 种族模板成品', () => {
        ...
        const result = resolve({ packs: [], 种族模板: ['human'] }, {}, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, lib);
