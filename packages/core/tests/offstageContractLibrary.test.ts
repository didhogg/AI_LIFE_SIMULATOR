...
describe('离场演化契约库 · 剥离③', () => {
  ...
  it('③ 契约载荷接受任意 record<string, unknown>', () => {
    ...
    expect((result.契约载荷?.['nested'] as Record<string,unknown>)?.['deep']).toEqual([1, 2, 3]);
  });
  ...
  it('④ resolve() 挂载 离场演化契约成品', () => {
    ...
    const result = resolve(
      ...
      undefined, undefined, undefined, undefined, undefined, lib,
    );
  ...
  // 断言⑦ 守恒门
  it('⑦ 守恒门：schemaKeys=54 / BUNDLE=21 / 命名空间枚举=32项（含离场演化契约）', () => {
