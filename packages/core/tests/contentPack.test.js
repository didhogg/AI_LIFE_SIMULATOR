...
import { 内容包元数据Schema, 内容包内容Schema, 内容包条目Schema, 内容包库Schema, 模块菜单键集, } from '../engine/preset/contentPack.js';
