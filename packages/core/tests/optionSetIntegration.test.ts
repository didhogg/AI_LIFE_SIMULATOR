...
function makeTransferOption(receiverPath: string, payerPath: string, counterAmount: number): 动词选项条目Type {
...
function makeCollectOption(receiverPath: string, sinkPath: string, counterAmount: number): 动词选项条目Type {
  return 动词选项条目Schema.parse({
    verb:           '赋予',
    target_choices: [receiverPath],
    tool_name:      'collect',
