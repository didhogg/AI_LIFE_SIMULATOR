...
import {
  ...
  投影社会角色权重表,
  投影社会角色效应量表,
} from '../schema/socialRoleLibrary.js';
...
describe('社会角色库 · 剥离③', () => {
  ...
  it('④ resolve() 挂载 社会角色成品', () => {
    const result = resolve(
      { packs: [], 社会角色: ['merchant', 'scholar'] },
      {},
      undefined, undefined, undefined, undefined, undefined, undefined, undefined,
      undefined, undefined, undefined, undefined, undefined, undefined,
      undefined, undefined, undefined, undefined, undefined, undefined, SAMPLE_LIB,
    );
  ...
  // 断言⑦ 守恒门
  it('⑦ 守恒门：schemaKeys=54 / BUNDLE=21 / 命名空间枚举=32项（含社会角色）', () => {
