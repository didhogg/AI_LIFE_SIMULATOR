...
import { 母题配额库Schema, 母题配额定义条目Schema, 母题配额ID正则, 投影母题配额库, } from '../schema/motifQuotaLibrary.js';
...
describe('母题配额库 · 剥离③', () => {
    ...
    it('⑥ resolve() 挂载 母题配额成品', () => {
        ...
        const result = resolve({ packs: [], 母题配额: ['romance'] }, {}, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, lib);
