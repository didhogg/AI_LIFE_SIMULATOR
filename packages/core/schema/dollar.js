...
// ── $涟漪候选（6.37 涟漪引擎暂存缓冲） ──
export const $涟漪候选Schema = z.record(z.string(), // 目标实体键
z.array(z.object({
    标签: z.string().default(''),
    极性: z.string().default(''),
...
export const $模型画像Schema = z.record(z.string(), // provider 键（claude/gpt/gemini…）
z.object({
...
export const $metaSchema = z.object({
    ...
    周目谱系: z.record(z.string(), z.object({
