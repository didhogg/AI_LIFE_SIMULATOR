...
export type 动词IdType = (typeof 动词Id枚举)[number];
...
export type EffectDeclType = z.infer<typeof EffectDeclSchema>;
...
export const 动词OptionSchema表 = {
  ...
  施加: 施加OptionSchema,
  植入: 植入OptionSchema,
} as const satisfies Record<动词IdType, typeof 转移OptionSchema>;
