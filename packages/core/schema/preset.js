...
export const 种族模板Schema = z.record(z.string(), // 种族键
z.object({
...
// ── 母题配额（6.14） ──
export const 母题配额Schema = z.record(z.string(), // 母题键
z.object({
...
// ── 媒体渠道表（6.9） ──
export const 媒体渠道表Schema = z.record(z.string(), // 渠道键
z.object({
    名称: z.string().default(''),
...
// 1c. 母题词汇表
export const 母题词汇表Schema = z.record(z.string(), // 母题键
z.object({
