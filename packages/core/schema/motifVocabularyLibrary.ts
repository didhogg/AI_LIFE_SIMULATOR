...
export const 母题词汇库Schema = z.record(
  z.string().regex(母题词汇ID正则, { message: '母题词汇ID 须为蛇形 /^[a-z][a-z0-9_]*$/' }),
  母题词汇定义条目Schema,
).default({});

export type 母题词汇定义条目Type = z.infer<typeof 母题词汇定义条目Schema>;
export type 母题词汇库Type       = z.infer<typeof 母题词汇库Schema>;
