...
export const 文风冰箱Schema = z.record(
  z.string().regex(文风ID正则, { message: '文风ID 须为蛇形 /^[a-z][a-z0-9_]*$/' }),
  文风定义条目Schema,
).default({});

export type 文风定义条目Type = z.infer<typeof 文风定义条目Schema>;
export type 文风冰箱Type     = z.infer<typeof 文风冰箱Schema>;
