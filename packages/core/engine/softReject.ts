...
export const SOFT_REJECT_KEYWORDS: readonly string[] = [
  // 中文：明确拒绝
...
export interface SoftRejectDetectResult {
  detected: boolean;
  matchedKeyword?: string;
  heuristicReason?: 'refusal_start_combo';
  ruleVersion: typeof SOFT_REJECT_RULE_VERSION;
}

// 确定性检测函数——相同输入恒相同输出，无随机性，无副作用
export function detectSoftReject(response: string): SoftRejectDetectResult {
