...
/** 可供死亡拦截扫描的包最小形状（intervention_pack_v1Type 的子集） */
export interface ScanableInterceptPack {
 ...
 */
export function scanDeathIntercept(
  packs: readonly ScanableInterceptPack[],
): string | null {
