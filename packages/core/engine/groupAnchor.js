 ...
 */
export function pinGroupAnchor(registry, groupId, tickId, epochMin, snapshot) {
    if (!groupId)
        throw new Error('pinGroupAnchor: groupId 不得为空串');
    ...
    const pin = { groupId, tickId, epochMin, snapshotHash };
 ...
 */
export function assertGroupAnchorExists(registry, groupId) {
 ...
 */
export function verifyGroupReplayIdempotency(snapshotA, snapshotB) {
