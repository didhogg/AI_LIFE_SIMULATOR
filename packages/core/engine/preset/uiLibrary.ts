...
export const UI库Schema = z.record(
  z.string().regex(UI_ID正则, { message: 'UI_ID 须为蛇形 /^[a-z][a-z0-9_]*$/' }),
  UI条目Schema,
).default({});

export type UI条目Type = z.infer<typeof UI条目Schema>;
export type UI库Type = z.infer<typeof UI库Schema>;
