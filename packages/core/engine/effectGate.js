 ...
 */
export function fillEffectPackHash(pack) {
 ...
 */
export function isEffectPackHashStale(pack) {
 ...
 */
export function runEffectGates(pack, whitelist = new Set()) {
    const errors = [];
    const clampedDeltas = [];
 ...
 */
export function computeEffectPackSetHash(packs) {
