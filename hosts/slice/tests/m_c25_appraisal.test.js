...
import { buildWorld, PC, NPC_WANG, NPC_HONG, LOC_NAME, EXPECTED_NET_ASSET, } from '../fixture/world.js';
...
describe('C2-5 FA-8 · SETTLEMENT_PHASES 计数 = 14', () => {
    it('SETTLEMENT_PHASES 含 14 个阶段（感知情绪化 + 编年史入册 新增）', () => {
    ...
    it('单拍结算全部 14 个阶段', () => {
        ...
        expect(settledPhases).toHaveLength(14);
