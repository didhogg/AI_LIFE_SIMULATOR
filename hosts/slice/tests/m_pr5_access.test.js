...
const schemaShape = RootSchema._def.shape();
import { projectCognition, buildInvestigationDelta, diffProjection, } from '@ai-life-sim/core/engine/cognitionProjection';
...
function buildCogWorld(overrides = {}) {
...
describe('G2 co-location 高导通', () => {
    it('G2-1 同场 → coLocated=true·access 比异场高', () => {
        const base = { 了解度: 0, 印象: [{ 标签: '关系', 极性: '正', 强度: 50, 来源: '', 获知时间: 0, 衰减速率: 0, 来源类型: '一手观测' }] };
        const s = buildCogWorld({
    ...
    it('G2-4 co-location 加成 capped at 100', () => {
        const s = buildCogWorld({
            认知档案: {
                [OBS]: { [TGT_A]: { 了解度: 0, 印象: [{ 标签: '关系', 极性: '正', 强度: 90, 来源: '', 获知时间: 0, 衰减速率: 0, 来源类型: '一手观测' }] } },
            },
        });
        const proj = projectCognition(s, OBS, { targetKeys: [TGT_A] });
    ...
    it('G2-5 一年80国回访：跨区后回原地·projection 确定性恢复同值', () => {
        ...
        const s1 = buildCogWorld({
            认知档案: { [OBS]: { [TGT_A]: { 了解度: 0, 印象: [{ 标签: '关系', 极性: '正', 强度: 50, 来源: '', 获知时间: 0, 衰减速率: 0, 来源类型: '一手观测' }] } } },
        });
        // 跨区后（OBS 移至 LOC_Y）
            ...
            认知档案: {
                [OBS]: {
                    [TGT_A]: {
                        了解度: 0,
                        印象: [
                            { 标签: '关系', 极性: '正', 强度: 60, 来源: '', 获知时间: 0, 衰减速率: 0, 来源类型: '一手观测',
                                factFragment: { 主体: TGT_A, 维度: '关系', Δ方向: 1, 量级: 60 } },
                            { 标签: '财富', 极性: '正', 强度: 60, 来源: '', 获知时间: 0, 衰减速率: 0, 来源类型: '一手观测',
        ...
        const s = RootSchema.parse({
            ...
            认知档案: {
                [OBS]: {
                    [TGT_A]: {
                        了解度: 0,
                        印象: [{ 标签: '声誉', 极性: '正', 强度: 60, 来源: '', 获知时间: 0, 衰减速率: 0, 来源类型: '一手观测',
...
// ── G4: 声望导通乘子（P5-4） ──────────────────────────────────────────────────
describe('G4 声望导通乘子', () => {
    function buildPrestigeWorld(prestige) {
        return RootSchema.parse({
            NPC: {
                [OBS]: { 姓名: '爱丽丝', 位置: LOC_Y }, // OBS 在 LOC_Y
            ...
            认知档案: {
                [OBS]: {
                    [TGT_A]: {
                        了解度: 0,
                        印象: [{ 标签: '关系', 极性: '正', 强度: 60, 来源: '', 获知时间: 0, 衰减速率: 0, 来源类型: '一手观测' }],
                    },
                },
            },
        });
    ...
    it('G4-4 声望乘子不使 access 超 100', () => {
        const s = RootSchema.parse({
            ...
            认知档案: {
                [OBS]: {
                    [TGT_A]: { 了解度: 0, 印象: [{ 标签: '关系', 极性: '正', 强度: 90, 来源: '', 获知时间: 0, 衰减速率: 0, 来源类型: '一手观测' }] },
                },
            },
        });
        const proj = projectCognition(s, OBS);
...
describe('G6 重投影 diff', () => {
        ...
        const s = buildCogWorld({
            ...
            认知档案: {
                [OBS]: {
                    ...
                    [TGT_B]: { 了解度: 0, 印象: [{ 标签: '关系', 极性: '正', 强度: 50, 来源: '', 获知时间: 0, 衰减速率: 0, 来源类型: '一手观测' }] },
                },
            },
        });
    ...
    it('G6-4 低→高重投影浮现具有确定性（P5-6）', () => {
        const s1 = buildCogWorld({
            NPC: { [OBS]: { 姓名: '爱丽丝', 位置: LOC_Y }, [TGT_A]: { 姓名: '鲍勃', 位置: LOC_X }, [TGT_B]: { 姓名: '卡罗尔', 位置: LOC_Y } },
            认知档案: { [OBS]: { [TGT_B]: { 了解度: 0, 印象: [{ 标签: '关系', 极性: '正', 强度: 50, 来源: '', 获知时间: 0, 衰减速率: 0, 来源类型: '一手观测' }] } } },
        });
        const s2 = structuredClone(s1);
            ...
            const s = RootSchema.parse({
                ...
                认知档案: {
                    [`obs_${seed}`]: {
                        [`tgt_${seed}`]: {
                            了解度: seed % 50,
                            印象: [{ 标签: '关系', 极性: '正', 强度: seed % 100, 来源: '', 获知时间: 0, 衰减速率: 0, 来源类型: '一手观测' }],
                        },
                    },
                },
            });
