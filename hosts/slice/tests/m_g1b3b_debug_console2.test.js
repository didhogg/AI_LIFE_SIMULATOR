...
import { buildDebugFixtureSmall, buildDebugFixtureMedium, buildDebugFixtureLarge, } from '../../web-debug/fixtures/debugFixtures.js';
import { runTickWithDiff, PHASE6_THRESHOLD } from '../../web-debug/aohpDebugConsole.js';
import { povInspect, comparePOVs, buildRelationGraph, buildPCPanel, buildMapThumbnail, buildStateTree, takeStateSnapshot, buildIncrementalView, ActionRecorder, SnapshotStore, } from '../../web-debug/aohpDebugConsole2.js';
// ──────────────────────────────────────────────────────────────────────────────
...
describe('T8 buildIncrementalView — 增量时间线聚合正确', () => {
    ...
    it('无变化时 summary = 「（本拍无变化）」', () => {
        ...
        const entry = tl[0];
        if (entry.cognitiveChangesCount === 0 &&
