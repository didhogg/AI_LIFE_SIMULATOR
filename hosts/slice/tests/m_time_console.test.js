...
import { resolveSpanMinutes, formatSpanDisplay, TimeController, runTickWithDiff, MINUTES_PER_DAY, MINUTES_PER_MONTH, MINUTES_PER_YEAR, } from '../../web-debug/aohpDebugConsole.js';
import { computeTickSpan, } from '@ai-life-sim/core/engine/time';
...
describe('T1 resolveSpanMinutes — 固定 preset 归一值', () => {
    const epoch = 0;
    const c = (qty, unit) => resolveSpanMinutes(epoch, 'custom', qty, unit);
    it('1min → 1', () => {
