...
import { CALL_TYPE_REGISTRY, NARRATIVE_CALL_TYPES, DEFAULT_NEAR_K, getCallTypeSpec, } from '@ai-life-sim/core/prompt/callRegistry';
...
function makeStateWithLore(predicate, 知识载荷) {
    return {
        ...BASE_STATE,
        _lore知识库: {
            'test:lore_entry': {
...
describe('P0-8 ① CALL_TYPE_REGISTRY 完整性', () => {
    ...
    it('每条记录都有上下文组装器/输出schema/温度/模型档位/超时重试策略', () => {
        for (const [, spec] of Object.entries(CALL_TYPE_REGISTRY)) {
